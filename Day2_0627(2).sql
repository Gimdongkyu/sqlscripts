...
-- char 타입
INSERT INTO tbl_string(acol) VALUES('abcdefghjij'); 
INSERT INTO tbl_string(acol) VALUES('abcdef'); 		--acol은 고정길이 타입: 공백 4개추가
INSERT INTO tbl_string(acol) VALUES('abcdeghjijklm'); --오류 : 길이 초과
...
--오류 열에 대한 값이 너무 큼(실제 :12 , 최대값: 10)
INSERT INTO tbl_string(acol) VALUES('가나');	-- 공백 4개


-- char 과 varchar2는 바이트 단위. nchar 과 nvarchar2는 문자개수 단위(다국어 문자가 많이 포함되는 컬럼에 적절)

--nchar 타입
INSERT INTO tbl_string(ccol) VALUES('가나다');-- 공백 7개
INSERT INTO tbl_string(ccol) VALUES('가나다라'); -- 공백 6개추가
INSERT INTO tbl_string(ccol) VALUES('가나');	-- 공백 8개

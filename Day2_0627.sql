...
col3 NUMBER(7,2),	-- 전체 최대 7자리수, 소수점 이하 2자리 고정 정수의 자리 : 7-2 = 5
col4 NUMBER(2,5)		-- 소수점이하 5자리 고정, 0아닌 유효숫자 최대 2자리	: 유효 0의 갯수가 3개(2-5 = -3)
);


-- 유효 숫자 : 12300 또는00123 첫번째 00은 유효값, 두번째 00은 불필요
-- 정상실행값 테스트 1
INSERT INTO tbl_number 
VALUES (123456,12345,12345.67,0.00012);
...
INSERT INTO TBL_NUMBER
VALUES (123456789, 123456, 123456,0.00012);
